function calculateForm(){
	console.log('calc');
	let asicCount = 1;//parseFloat(document.getElementById('asicCount').value);
	...
	let hwCost = 0;//parseFloat(document.getElementById('hwCost').value);
	...
	let myHashratePercent = myHashrate/1000 / netHashrate;
